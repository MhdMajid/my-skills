...
name: neon-postgres
description: >-
  إرشادات وأفضل الممارسات للعمل مع Neon Serverless Postgres.
  تغطي الإعداد، طرق الاتصال، التفرع، التوسع التلقائي، التوقف إلى الصفر،
  النسخ المتماثلة للقراءة، تجميع الاتصالات، Neon Auth، وNeon CLI، خادم MCP،
  REST API، TypeScript SDK، وPython SDK.
  تُستخدم عندما يسأل المستخدمون عن "إعداد Neon"، "الاتصال بـ Neon"، "مشروع Neon"،
  "DATABASE_URL"، "serverless Postgres"، "Neon CLI"، "neonctl"، "Neon MCP"،
  "Neon Auth"، "@neondatabase/serverless"، "@neondatabase/neon-js"،
  "scale to zero"، "التوسع التلقائي لـ Neon"، "النسخة المتماثلة للقراءة من Neon"، أو
  "تجميع اتصالات Neon".
---
