---
name: shadcn
description: يدير مكونات ومشاريع shadcn - إضافة، بحث، إصلاح، تصحيح الأخطاء، تصميم، وتكوين واجهة المستخدم، بما في ذلك واجهات الدردشة. يوفر سياق المشروع، ووثائق المكونات، وأمثلة الاستخدام. ينطبق عند العمل مع shadcn/ui، وسجلات المكونات، والإعدادات المسبقة، ورموز --preset، أو أي مشروع يحتوي على ملف components.json. كما يُفعّل أوامر "shadcn init"، و"إنشاء تطبيق باستخدام --preset"، و"التبديل إلى --preset".".
